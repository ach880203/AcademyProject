...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/shop.css">
...
<body>
	...
	<table class="list">
		<tr>
			<td colspan="5"
				style="border: white; text-align: left; font-size: 25px"><b>회원정보</b></td>
		</tr>
		...
		<c:forEach var="m" items="${memberList}">
			<tr>
				...
				<td><a
					href="<%=request.getContextPath()%>/FruitServlet?command=fruit_UDP&user_id=${m.userId}">
						${m.name} </a></td>
